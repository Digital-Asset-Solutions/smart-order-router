...
export const V4_ETH_WETH_FAKE_POOL: { [chainId in ChainId]: V4Pool } = {
  ...
  [ChainId.EDEN_TESTNET]: new V4Pool(
    nativeOnChain(ChainId.EDEN_TESTNET),
    nativeOnChain(ChainId.EDEN_TESTNET).wrapped,
    0,
    FAKE_TICK_SPACING,
    ADDRESS_ZERO,
    79228162514264337593543950336,
  ...
  [ChainId.SOMNIA]: new V4Pool(
    nativeOnChain(ChainId.SOMNIA),
    nativeOnChain(ChainId.SOMNIA).wrapped,
    0,
    FAKE_TICK_SPACING,
    ADDRESS_ZERO,
    79228162514264337593543950336,
  ...
  [ChainId.EDEN]: new V4Pool(
    nativeOnChain(ChainId.EDEN),
    nativeOnChain(ChainId.EDEN).wrapped,
    0,
    FAKE_TICK_SPACING,
    ADDRESS_ZERO,
    79228162514264337593543950336,
